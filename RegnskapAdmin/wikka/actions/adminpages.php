...
if ($this->IsAdmin($this->GetUser()))
{
	...
	define('ADMINPAGES_PAGE_TITLE','Sideadministrasjon');
	define('ADMINPAGES_FORM_LEGEND','Filtrer visning:');
	define('ADMINPAGES_FORM_SEARCH_STRING_LABEL','S&oslash;k i side:');
	define('ADMINPAGES_FORM_SEARCH_STRING_TITLE','Skriv inn s&oslash;kekriterie');
	define('ADMINPAGES_FORM_SEARCH_SUBMIT','S&oslash;');
	define('ADMINPAGES_FORM_DATE_RANGE_STRING_LABEL','Siste redigering: mellom');
	define('ADMINPAGES_FORM_DATE_RANGE_CONNECTOR_LABEL','og');
	define('ADMINPAGES_FORM_PAGER_LABEL_BEFORE','Vis');
	define('ADMINPAGES_FORM_PAGER_TITLE','Velg antall visninger per side');
	define('ADMINPAGES_FORM_PAGER_LABEL_AFTER','visninger per side');
	define('ADMINPAGES_FORM_PAGER_SUBMIT','Bruk');
	define('ADMINPAGES_FORM_PAGER_LINK','Vis sider fra %d to %d');
	define('ADMINPAGES_FORM_RESULT_INFO','Sider');
	define('ADMINPAGES_FORM_RESULT_SORTED_BY','Sortert etter:');
	define('ADMINPAGES_TABLE_HEADING_PAGENAME','Page Name');
	define('ADMINPAGES_TABLE_HEADING_PAGENAME_TITLE','Sortert etter sidenavn');
	define('ADMINPAGES_TABLE_HEADING_OWNER','Eier');
	define('ADMINPAGES_TABLE_HEADING_OWNER_TITLE','Sorter etter eier');
	define('ADMINPAGES_TABLE_HEADING_LASTAUTHOR','Endret sist av');
	define('ADMINPAGES_TABLE_HEADING_LASTAUTHOR_TITLE','Sorter etter endret sist av');
	define('ADMINPAGES_TABLE_HEADING_LASTEDIT','Siste redigeringstidspunkt');
	define('ADMINPAGES_TABLE_HEADING_LASTEDIT_TITLE','Sorter etter siste redigeringstidspunkt');
	define('ADMINPAGES_TABLE_SUMMARY','Sider p&aring; denne serveren');
	define('ADMINPAGES_TABLE_HEADING_HITS_TITLE','Treff');
	define('ADMINPAGES_TABLE_HEADING_REVISIONS_TITLE','Revisjoner');
	define('ADMINPAGES_TABLE_HEADING_COMMENTS_TITLE','Kommentarer');
	define('ADMINPAGES_TABLE_HEADING_BACKLINKS_TITLE','Tilbakelinker');
	define('ADMINPAGES_TABLE_HEADING_REFERRERS_TITLE','Refererere');
	define('ADMINPAGES_TABLE_HEADING_HITS_ALT','Treff');
	define('ADMINPAGES_TABLE_HEADING_REVISIONS_ALT','Revisjoner');
	define('ADMINPAGES_TABLE_HEADING_COMMENTS_ALT','Kommentarer');
	define('ADMINPAGES_TABLE_HEADING_BACKLINKS_ALT','Tilbakelinker');
	define('ADMINPAGES_TABLE_HEADING_REFERRERS_ALT','Refererere');
	define('ADMINPAGES_TABLE_HEADING_ACTIONS','Aksjoner');
	define('ADMINPAGES_ACTION_EDIT_LINK_TITLE','Rediger %s');
	define('ADMINPAGES_ACTION_DELETE_LINK_TITLE','Slett %s');
	define('ADMINPAGES_ACTION_CLONE_LINK_TITLE','Klon %s');
	define('ADMINPAGES_ACTION_RENAME_LINK_TITLE','Om&oslash;p %s (AVSKRUDD)');
	define('ADMINPAGES_ACTION_ACL_LINK_TITLE','Endre tilgangskontroll for %s');
	/* define('ADMINPAGES_ACTION_INFO_LINK_TITLE','Display information and statistics for %s'); */ #not implemented yet
	define('ADMINPAGES_ACTION_REVERT_LINK_TITLE','Bytt %s til forrige versjon');
	define('ADMINPAGES_ACTION_EDIT_LINK','rediger');
	define('ADMINPAGES_ACTION_DELETE_LINK','slett');
	define('ADMINPAGES_ACTION_CLONE_LINK','klon');
	define('ADMINPAGES_ACTION_RENAME_LINK','omd&oslash;p');
	define('ADMINPAGES_ACTION_ACL_LINK','tilgangsliste');
	define('ADMINPAGES_ACTION_INFO_LINK','info');
	define('ADMINPAGES_ACTION_REVERT_LINK', 'tilbakestill');
	define('ADMINPAGES_TAKE_OWNERSHIP_LINK','Ta eierskap p&aring;');
	define('ADMINPAGES_NO_OWNER','(Ingen)');
	define('ADMINPAGES_TABLE_CELL_HITS_TITLE','Treff for %s (%d)');
	define('ADMINPAGES_TABLE_CELL_REVISIONS_TITLE','Vis revisjoner for %s (%d)');
	define('ADMINPAGES_TABLE_CELL_COMMENTS_TITLE','Vis kommentarer for %s (%d)');
	define('ADMINPAGES_TABLE_CELL_BACKLINKS_TITLE','Vis sider som lenker til %s (%d)');
	define('ADMINPAGES_TABLE_CELL_REFERRERS_TITLE','Vis eksterne sider som lenker til %s (%d)');
	define('ADMINPAGES_SELECT_RECORD_TITLE','Velg %s');
	define('ADMINPAGES_NO_EDIT_NOTE','(No edit note)');
	define('ADMINPAGES_CHECK_ALL_TITLE','Velg alle sider');
	define('ADMINPAGES_CHECK_ALL','Velg alle');
	define('ADMINPAGES_UNCHECK_ALL_TITLE','Avvelg alle sider');
	define('ADMINPAGES_UNCHECK_ALL','Avvelg alle');
	define('ADMINPAGES_FORM_MASSACTION_LEGEND','Masseaksjon');
	define('ADMINPAGES_FORM_MASSACTION_LABEL','Med utvalgte');
	define('ADMINPAGES_FORM_MASSACTION_SELECT_TITLE','Velg aksjon &aring; utf&oslash; p&aring; valgte sider (AVSKRUDD)');
	define('ADMINPAGES_FORM_MASSACTION_OPT_DELETE','Slett alle');
	define('ADMINPAGES_FORM_MASSACTION_OPT_CLONE','Klon alle');
	define('ADMINPAGES_FORM_MASSACTION_OPT_RENAME','Omd&oslash;p alle');
	define('ADMINPAGES_FORM_MASSACTION_OPT_ACL','Endre tilgangsliste');
	define('ADMINPAGES_FORM_MASSACTION_OPT_REVERT','Bytt til forrige versjon av side');
	define('ADMINPAGES_FORM_MASSACTION_REVERT_ERROR','Kan ikke reverseres');
	define('ADMINPAGES_FORM_MASSACTION_SUBMIT','Utf&oslash;r');
	define('ADMINPAGES_ERROR_NO_MATCHES','Beklager, det er ingen sider som treffer "%s"');
	define('ADMINPAGES_LABEL_EDIT_NOTE','Gi inn kommentar eller gi inn blank for standard');
	if (!defined('WHEN_BY_WHO')) define('WHEN_BY_WHO', '%1$s av %2$s');
	if (!defined('ADMINPAGES_CANCEL_LABEL')) define('ADMINPAGES_CANCEL_LABEL', 'Avbryt');
